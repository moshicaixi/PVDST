...
from models.pvcnn_utils import create_mlp_components, create_pointnet_components

__all__ = ['PVCNN']


class PVCNN_semseg(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return self.classifier(torch.cat(out_features_list, dim=1)), None
...
class get_model(nn.Module):
    def __init__(self, num_class, extra_channel=6):
        ...
        # extra_channel = 6
        self.feat = PVCNN_semseg(num_classes=num_class, extra_feature_channels=extra_channel)
